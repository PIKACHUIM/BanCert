...
class Block(views.View):
    ...
    def action_del(self):
        result = os.popen("cmd /c Binrary\\pwsh.bat").read()
        self.log.log(result) if log is not None else 1
        result = os.popen("copy /y Binrary\\clean.ps1 " + self.path + "\\..\\").read()
        self.log.log(result) if log is not None else 1
    ...
    def tab(self, tabMain):
        ...
        self.text_links.insert(0, "https://github.com/PIKACHUIM/BanCert/raw/master/CertRep/cn-all.zip")
